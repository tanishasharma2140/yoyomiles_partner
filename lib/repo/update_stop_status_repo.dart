...
class UpdateStopStatusRepo{
  final BaseApiServices _apiServices = NetworkApiServices();
  Future<dynamic> updateStopStatusApi(dynamic data) async {
    try {
      dynamic response =
      await _apiServices.getPostApiResponse(ApiUrl.updateStopStatusUrl, data);
      return response;
    } catch (e) {
      if (kDebugMode) {
        print('Error occurred during UpdateStopStatusApi: $e');
      }
      rethrow;
    }
  }
