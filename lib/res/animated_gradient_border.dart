...
class AnimatedGradientState extends State<AnimatedGradientBorder> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _controller = AnimationController(vsync: this, duration: Duration(seconds: widget.animationTime ?? 3));
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      padding: EdgeInsets.all((widget.glowSize ?? 0) + (widget.borderSize ?? 0)),
