...
class _LiveRideScreenState extends State<LiveRideScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      cabCancelReasonVm.cancelReasonApi("2");
  ...
  Future<void> _openGoogleMapsDirections() async {
    ...
    if (liveData.stops != null && liveData.stops!.isNotEmpty) {
      final pendingStop = liveData.stops!.indexWhere(
        (s) => s.status.toString() == "0",
      );
      if (pendingStop != -1) {
  ...
  void _handleReachedButtonClick() async {
    ...
    if (liveData.stops != null && liveData.stops!.isNotEmpty) {
      final pendingStopIndex = liveData.stops!.indexWhere(
        (s) => s.status.toString() == "0",
      );
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      height:
                          ((cancelReasonVm.cancelReasonModel?.data?.length ??
                                      0) *
                                  50)
                              .toDouble()
                              .clamp(150, 300),
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          final reason =
                              cancelReasonVm.cancelReasonModel?.data?[index];
                ...
                children: [
                  SizedBox(
                    ...
                    child: ConstMap(
                      ...
                      onAddressFetched: (address) => mounted
                    ...
                    ...liveData.stops!.asMap().entries.map((entry) {
                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          _buildDetailRow(
                            title: "Status",
                            content: stop.status.toString() == "1"
                                ? "Reached"
                                : "Pending",
                            bold: true,
                          ),
                          if (idx != liveData.stops!.length - 1)
                        ...
                        child: InkWell(
                          onTap: () async {
                            ...
                            try {
                              ...
                              if (mounted)
                                setState(
                                  () => _localRideStatus = currentStatus,
                                );
                              if (mounted)
                                Utils.showErrorMessage(
                                  context,
