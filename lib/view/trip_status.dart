...
//   void initState() {
//     super.initState();
//     print("kkdkeiemdiemdiemdee");
//     getCurrentLocation();
//     final ride = Provider.of<RideViewModel>(context, listen: false);
//     ride.handleRideUpdate("", context);
//     // Keep Android-side FCM gating in sync with current toggle.
//     _safeInvokeOnline(isSwitched);
//
//   }
//
...
//   }
//
//   Future<void> _safeInvokeOnline(bool online) async {
//     try {
//       await _channel.invokeMethod<void>('setOnline', {'online': online});
//     } catch (_) {
//       // no-op
//     }
//   }
...
//         userIds = userId!;
//       });
//       print("🧠 userIds state updated: $userIds");
//
...
//
//       print("🧭 Converting lat/lng to address...");
...
//       if (mounted) {
//         setState(() {});
//         print("🔄 UI updated with new address");
//       }
//
//       Provider.of<ConstMapController>(context, listen: false)
//           .toggleLightMode(true);
//
//       print("🎯 getCurrentLocation END SUCCESS");
//     } catch (e) {
